...
class PutSymlinkV2Input : public GenericInput {
public:
    PutSymlinkV2Input() = default;
    ~PutSymlinkV2Input() = default;
    PutSymlinkV2Input(std::string bucket, std::string key, std::string symlinkTarget)
            : putObjectBasicInput_(std::move(bucket), std::move(key)), symlinkTarget_(std::move(symlinkTarget)) {
    }
    PutSymlinkV2Input(const PutObjectBasicInput& putobjectbasicinput, std::string symlinkTarget)
            : putObjectBasicInput_(putobjectbasicinput), symlinkTarget_(std::move(symlinkTarget)) {
    }
    PutSymlinkV2Input(std::string bucket, std::string key) : putObjectBasicInput_(std::move(bucket), std::move(key)) {
    }
