...
class FetchObjectInput : public GenericInput {
public:
    FetchObjectInput(std::string bucket, std::string key) : bucket_(std::move(bucket)), key_(std::move(key)) {
    }
    FetchObjectInput(std::string bucket, std::string key, ACLType acl, StorageClassType storageClass,
    ...
    FetchObjectInput() = default;
    virtual ~FetchObjectInput() = default;
