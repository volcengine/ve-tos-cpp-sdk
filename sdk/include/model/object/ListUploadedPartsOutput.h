...
public:
  ...
  int getPartNumberMarker() const { return partNumberMarker_; }
  void setPartNumberMarker(int partNumberMarker) { partNumberMarker_ = partNumberMarker; }
  int getNextPartNumberMarker() const { return nextPartNumberMarker_; }
  void setNextPartNumberMarker(int nextPartNumberMarker) { nextPartNumberMarker_ = nextPartNumberMarker; }
  int getMaxParts() const { return maxParts_; }
  void setMaxParts(int maxParts) { maxParts_ = maxParts; }
  ...
  const std::vector<UploadedPart> &getUploadedParts() const { return uploadedParts_; }
  void setUploadedParts(const std::vector<UploadedPart> &uploadedParts) { uploadedParts_ = uploadedParts; }
