...
public:
  ...
  int getTaskNum() const { return taskNum_; }
  void setTaskNum(int taskNum) { taskNum_ = taskNum; }
  bool isEnableCheckpoint() const { return enableCheckpoint_; }
  void setEnableCheckpoint(bool enableCheckpoint) {
    enableCheckpoint_ = enableCheckpoint;
  }
  const std::string &getCheckpointFile() const { return checkpointFile_; }
