...
public:
  ...
  ~UploadPartCopyOutput() = default;
  UploadPartCopyOutput(RequestInfo requestInfo,
                       std::string versionId,
                       std::string sourceVersionId, int partNumber,
                       std::string etag, std::string lastModified)
      : requestInfo_(std::move(requestInfo)), versionID_(std::move(versionId)),
        sourceVersionID_(std::move(sourceVersionId)), partNumber_(partNumber), etag_(std::move(etag)),
