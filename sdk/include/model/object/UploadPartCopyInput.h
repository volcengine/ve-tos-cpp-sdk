...
public:
  ...
  const std::string &getDestinationKey() const { return destinationKey_; }
  void setDestinationKey(const std::string &destinationKey) { destinationKey_ = destinationKey; }
  const std::string &getSourceBucket() const { return sourceBucket_; }
  void setSourceBucket(const std::string &sourceBucket) { sourceBucket_ = sourceBucket; }
  const std::string &getSourceKey() const { return sourceKey_; }
  void setSourceKey(const std::string &sourceKey) { sourceKey_ = sourceKey; }
  ...
  int64_t getStartOffset() const { return startOffset_; }
  void setStartOffset(int64_t startOffset) { startOffset_ = startOffset; }
