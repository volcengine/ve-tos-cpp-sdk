...
public:
  ...
  const UploadPartOutput &getPart() const { return part_; }
  void setPart(const UploadPartOutput &part)  { part_ = part; }
  int64_t getOffset() const { return offset_; }
  void setOffset(int64_t offset) { offset_ = offset; }
  int getPartNum() const { return partNum_; }
  void setPartNum(int partNum) { partNum_ = partNum; }
  ...
  void setIsCompleted(bool isCompleted) { isCompleted_ = isCompleted; }
