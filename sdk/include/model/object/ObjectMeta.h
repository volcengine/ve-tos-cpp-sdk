...
public:
    ...
    const std::string& getRestore() const {
        return restore_;
    }
    void setRestore(const std::string& restore) {
        restore_ = restore;
    }
    ...
    const std::string& getMirrorTag() const {
        return mirrorTag_;
    }
    void setMirrorTag(const std::string& mirrorTag) {
        mirrorTag_ = mirrorTag;
    }
    ...
    const std::string& getCsType() const {
        return csType_;
    }
    void setCsType(const std::string& csType) {
        csType_ = csType;
    }
    void setContentLength1(long contentLength) {
        contentLength_ = contentLength;
    }
