...
public:
  ...
  const std::string &getMarker() const { return marker_; }
  void setMarker(const std::string &marker) { marker_ = marker; }
  int64_t getMaxKeys() const { return maxKeys_; }
  void setMaxKeys(int64_t maxKeys) { maxKeys_ = maxKeys; }
  const std::string &getNextMarker() const { return nextMarker_; }
  void setNextMarker(const std::string &nextMarker) { nextMarker_ = nextMarker; }
  ...
  const std::vector<ListedObject> &getContents() const { return contents_; }
  void setContents(const std::vector<ListedObject> &contents) { contents_ = contents; }
