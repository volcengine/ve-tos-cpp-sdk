...
public:
  ...
  void setGrantFullControl(const std::string &grantFullControl) { grantFullControl_ = grantFullControl; }
  const std::string &getGrantRead() const { return grantRead_; }
  void setGrantRead(const std::string &grantRead) { grantRead_ = grantRead; }
  const std::string &getGrantReadAcp() const { return grantReadAcp_; }
  void setGrantReadAcp(const std::string &grantReadAcp) { grantReadAcp_ = grantReadAcp; }
