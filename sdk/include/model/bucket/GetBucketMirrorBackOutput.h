                    ...
                    if (redirect.contains("PublicSource")) {
                        ...
                        if (publicSource.contains("SourceEndpoint")) {
                            ...
                            if (sourceEndpoint.contains("Primary")) {
                                sourceEndpoint_.setPrimary(
                                        sourceEndpoint.at("Primary").get<std::vector<std::string>>());
                            }
                            if (sourceEndpoint.contains("Follower")) {
                                sourceEndpoint_.setFollower(
                                        sourceEndpoint.at("Follower").get<std::vector<std::string>>());
                            }
