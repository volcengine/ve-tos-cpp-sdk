...
class HeadBucketAsyncInput final : public BaseHttp,
...
public:
    HeadBucketAsyncInput() = delete;
    ~HeadBucketAsyncInput() override = default;
    explicit HeadBucketAsyncInput(const std::string& bucket) : BucketBaseInput(bucket) {
    }
