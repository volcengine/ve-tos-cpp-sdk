...
class PutObjectFromFileAsyncOutput : public BaseOutput, public ChecksumBase, public SseBase {
    friend class TosAsyncClient;

public:
    PutObjectFromFileAsyncOutput() = default;
    ~PutObjectFromFileAsyncOutput() override = default;
