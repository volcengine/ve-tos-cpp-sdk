...
public:
  ...
  const ObjectAclGrant &getAclGrant() const { return aclGrant_; }
  void setAclGrant(const ObjectAclGrant &aclGrant) { aclGrant_ = aclGrant; }
  const ObjectAclRules &getAclRules() const { return aclRules_; }
  void setAclRules(const ObjectAclRules &aclRules) { aclRules_ = aclRules; }
