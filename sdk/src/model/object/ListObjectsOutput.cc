...
VolcengineTos::ListedObject parseListedObject(const json& object) {
    ...
    if (object.contains("LastModified"))
        lo.setLastModified(object.at("LastModified").get<std::string>());
    ...
    if (object.contains("StorageClass"))
        lo.setStorageClass(object.at("StorageClass").get<std::string>());
    if (object.contains("Type"))
        lo.setType(object.at("Type").get<std::string>());
    return lo;
}
