...
bool VolcengineTos::ObjectMeta::operator==(const VolcengineTos::ObjectMeta& rhs) const {
    return contentLength_ == rhs.contentLength_ && contentType_ == rhs.contentType_ && contentMD5_ == rhs.contentMD5_ &&
           contentLanguage_ == rhs.contentLanguage_ && contentEncoding_ == rhs.contentEncoding_ &&
           contentDisposition_ == rhs.contentDisposition_ && lastModified_ == rhs.lastModified_ &&
           cacheControl_ == rhs.cacheControl_ && expires_ == rhs.expires_ && etags_ == rhs.etags_ &&
           versionID_ == rhs.versionID_ && deleteMarker_ == rhs.deleteMarker_ && objectType_ == rhs.objectType_ &&
           storageClass_ == rhs.storageClass_ && restore_ == rhs.restore_ && metadata_ == rhs.metadata_ &&
           mirrorTag_ == rhs.mirrorTag_ && sseCustomerAlgorithm_ == rhs.sseCustomerAlgorithm_ &&
