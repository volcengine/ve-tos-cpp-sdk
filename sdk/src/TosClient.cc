...
Outcome<TosError, UploadFileOutput> TosClient::uploadFile(const std::string& bucket, const UploadFileInput& input) {
...
Outcome<TosError, DeleteMultiObjectsOutput> TosClient::deleteMultiObjects(const std::string& bucket,
...
Outcome<TosError, ListObjectVersionsOutput> TosClient::listObjectVersions(const std::string& bucket,
                                                                          const ListObjectVersionsInput& input) {
    return tosClientImpl_->listObjectVersions(bucket, input);
}

Outcome<TosError, CopyObjectOutput> TosClient::copyObject(const std::string& bucket, const std::string& srcObjectKey,
...
Outcome<TosError, UploadPartCopyOutput> TosClient::uploadPartCopy(const std::string& bucket,
...
Outcome<TosError, PutObjectAclOutput> TosClient::putObjectAcl(const std::string& bucket,
...
Outcome<TosError, CreateMultipartUploadOutput> TosClient::createMultipartUpload(const std::string& bucket,
...
Outcome<TosError, CompleteMultipartUploadOutput> TosClient::completeMultipartUpload(
...
Outcome<TosError, AbortMultipartUploadOutput> TosClient::abortMultipartUpload(const std::string& bucket,
                                                                              const AbortMultipartUploadInput& input) {
    return tosClientImpl_->abortMultipartUpload(bucket, input);
}
Outcome<TosError, ListUploadedPartsOutput> TosClient::listUploadedParts(const std::string& bucket,
...
Outcome<TosError, ListMultipartUploadsOutput> TosClient::listMultipartUploads(const std::string& bucket,
                                                                              const ListMultipartUploadsInput& input) {
    return tosClientImpl_->listMultipartUploads(bucket, input);
}

Outcome<TosError, std::string> TosClient::preSignedURL(const std::string& httpMethod, const std::string& bucket,
...
Outcome<TosError, PutBucketPolicyOutput> TosClient::putBucketPolicy(const std::string& bucket,
                                                                    const std::string& policy) {
    return tosClientImpl_->putBucketPolicy(bucket, policy);
}
Outcome<TosError, GetBucketPolicyOutput> TosClient::getBucketPolicy(const std::string& bucket) {
    return tosClientImpl_->getBucketPolicy(bucket);
}
Outcome<TosError, DeleteBucketPolicyOutput> TosClient::deleteBucketPolicy(const std::string& bucket) {
